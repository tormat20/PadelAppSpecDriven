...
2. Create an WinnersCourt event with 2 selected courts.
...
curl -X POST http://127.0.0.1:8000/api/v1/events \
  -H "Content-Type: application/json" \
  -d '{"eventName":"Thursday Padel","eventType":"WinnersCourt","eventDate":"2026-02-26","selectedCourts":[1,2],"playerIds":[]}'
```
