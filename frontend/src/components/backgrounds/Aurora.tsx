...
const DEFAULT_COLOR_STOPS: [string, string, string] = ["#f6f5f4", "#1c71d8", "#9a9996"]
...
export function Aurora({
  ...
  useEffect(() => {
    ...
    // Remove uv attribute if present — not needed by this shader
    ...
    // amplitude change remounts the effect (same pattern as original)
