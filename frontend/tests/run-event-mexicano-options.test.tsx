...
import { getMexicanoSideScoreOptions, getMirroredBadgePair, toMexicanoPayload } from "../src/features/run-event/resultEntry"
...
describe("RunEvent Mexicano modal options", () => {
  ...
  it("mirrors badge display values for both sides", () => {
    expect(getMirroredBadgePair({ mode: "Mexicano", team1Score: 15, team2Score: 9 })).toEqual({
      team1: "15",
      team2: "9",
    })
  })
