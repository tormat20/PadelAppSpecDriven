...
class MexicanoService:
    def generate_round_1(self, player_ids: list[str], courts: list[int], event_seed: str = ""):
        return generate_round_1(EventType.MEXICANO, player_ids, courts, event_seed=event_seed)
